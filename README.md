<p align="center">
  <a href="https://paybill.dev" target="_blank">
    <picture>
      <img src="./static/aws-codebuild.png" alt="Banner" />
    </picture>
  </a>
</p>

# Amazon CodeBuild Setup

This module provisions a fully configurable **AWS CodeBuild project**, including optional **authentication credentials for GitHub/Bitbucket repositories**.

#### **Core functionality**

* Creates an **AWS CodeBuild project** with variables that control:

  * Build environment (image, compute type, privileged mode for Docker builds)
  * Source repository (GitHub, CodeCommit, Bitbucket, S3)
  * Buildspec file configuration
  * Artifacts output settings
  * Caching (LOCAL or S3)
  * VPC networking (subnets + security groups)
  * Environment variables (plaintext/Parameter Store/Secrets Manager)
  * Logging to **CloudWatch** and/or **S3**
  * Build timeouts, badge enablement, encryption keys, concurrent builds, etc.
